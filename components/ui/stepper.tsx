...
type StepperStepState =
  "inactive" | "active" | "completed" | "disabled" | "error";
...
type StepperPropsWithoutSteps<TValue extends StepperValue = StepperValue> =
...
function StepperContent<TValue extends StepperValue = StepperValue>({
  ...
  return (
    <Comp
      ...
      className={cn(
        "border-border/70 bg-muted/25 text-foreground rounded-lg border p-4 text-sm shadow-sm",
        className,
      )}
      {...props}
    >
