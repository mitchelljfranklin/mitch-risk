...
See [Appearance](appearance.md) for full details.
...
See [Email Configuration](email.md) for template token reference and SMTP setup.
...
See [Scoring Configuration](scoring.md) for examples and formula details.
...
See [SSO Configuration](sso.md) for per-provider setup guides.
